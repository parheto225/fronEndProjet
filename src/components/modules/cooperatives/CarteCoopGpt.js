    ...
    const onEachFeature = (feature, layer) => {
        if (feature.properties) {
            ...
            layer.bindPopup(`                
                ...
                🧑‍🌾 <b>Propriétaire:</b> ${name}<br>              
                📐 <b>Superficie:</b> ${feature.properties.AREA} Ha<br>           
            `);
        }
    };
            ...
            <div style={{ width: '350px', backgroundColor: "#D6D8C7", padding: '10px', borderRight: '1px solid #ccc' }} className="mt-2 p-3 border-2 rounded-5 legend">
                ...
                <div className="legend" style={{listStyle: null, marginTop: "10px"}}>
                    ...
                    <label>
                        ...
                        <span style={{fontWeight: "bold", fontSize: "20px"}}><i> {t("Risque élevé")} </i></span>
                        <div style={{float: "right", marginRight: "10px"}}> 
                            <span className="superawesome" 
                                style={{
                                    border: "1px",
                    ...
                    <label>
                        <input type="checkbox" checked={''} onChange={() => toggleLayer('')} />
                        <span style={{fontWeight: "bold", fontSize: "20px"}}><i> {t("Risque modéré")} </i></span>
                        <div style={{float: "right", marginRight: "10px"}}> 
                            <span className="superawesome" 
                                style={{
                                    border: "1px",
                    ...
                    <label>
                    <input type="checkbox" checked={''} onChange={() => toggleLayer('')} />
                        <span style={{fontWeight: "bold", fontSize: "20px"}}><i> {t("Risque zéro")} </i></span>
                        <div style={{float: "right", marginRight: "10px"}}> 
                            <span className="superawesome" 
                                style={{
                                    border: "1px",
            ...
            <div style={{flex: 1, position: "relative", height: "90vh", overflow: "hidden"}}>
                ...
                <div className="bg-white p-3 border-5 rounded-5" style={{ marginTop: "10px", height: "150px", marginBottom: "50px" }}>
                    <ul style={{marginTop: "0px", fontSize: "18px"}}>
                        ...
                        <li style={{marginBottom: "50px"}}>{t("Données Invalides : Ensemble des parcelles ayant des irrégularités de polygones et de positionnement")}
                        </li>
                    </ul>
                </div>    
            </div>
