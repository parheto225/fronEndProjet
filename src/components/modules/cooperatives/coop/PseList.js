...
function PseList(){
    ...
    const fetchData = () => {
        axios.get(url+'/pse-list/?coopID='+coopID)
          .then((resp) => {
    ...
    const onSearchParcelle=(event)=>{
        try {
          axios.get(url+'/pse-list/?q='+event.target.value+'&co='+coopID).then((resp)=>{
...
//console.log(parcelleList);
    return(
        <>
            ...
            <h2 className="text-bold text-1100 mb-5">{t("Producteurs éligibles pour les PSE")} ({totalParc})</h2>
                        ...
                        <h5 class="card-title" style={{
                            ...
                            <div className="row">
                                <div className="row">
                                    ...
                                    <div className="col-xs-9" >                                                    
                                      <h3 className="card-title text-end" style={{marginTop: "-35px", fontWeight: "900", fontSize: "1.5rem"}}>{cooperative.total_parcelles_coop?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ")}</h3>
                                    </div>
                                </div>
                            </div>   
                ...
                <div className="row align-items-center justify-content-between g-3 mb-4">
                  ...
                  <div className="col-auto">
                    <div className="d-flex align-items-center">
                        ...
                        <button className="btn btn-sm" type="button" style={{backgroundColor: "#94a91b", color: "#fff", fontWeight: "bold"}}>
                  ...
                  <div className="table-responsive scrollbar ms-n1 ps-1">
                    <table className="table fs--1 mb-0">
                          ...
                          <tr className="" style={{backgroundColor: "#EE9F27", color: "#fff", fontWeight: "bold"}}>
                              ...
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="stage">Monitoring</th> 
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="type">Taux Réussite</th>
                              <th className="sort align-middle text-center text-uppercase" scope="col" data-sort="type">Revenu</th>             
                          ...
                          <tbody className="list" id="lead-details-table-body">
                            ...
                            <tr className="hover-actions-trigger text-center btn-reveal-trigger position-static">
                                  <td className="description align-middle white-space-nowrap text-black text-center text-700 py-2 pe-6" onClick={()=>ViewProducteur(parc?.planting?.parcelle?.producteur?.code)}>{parc?.planting?.parcelle.code}</td>
                                  <td className="name align-middle white-space-nowrap py-2 ps-0 ">
                                    <span className="d-flex align-items-center text-1000 cursor-pointer" >
                                      ...
                                      <h6 className="mb-0 text-1000 fw-bold " style={{color: "#168bc9"}}>{parc?.Producteur}</h6>
                                    </span>                                    
                                  </td>
                                  <td className="description align-middle white-space-nowrap fw-bold  text-center text-700 py-2 pe-6">{parc?.Contact}</td>
                                  <td className="description align-middle white-space-nowrap fw-bold text-center text-700 py-2 pe-6">{parc?.campagne?.libelle}</td>
                                  <td className="description align-middle white-space-nowrap text-center fw-bold text-700 py-2 pe-6">{parc?.planting?.parcelle?.superficie}</td>
                                  <td className="description align-middle white-space-nowrap text-center fw-bold text-700 py-2 pe-6">{parc?.sumPlantEspece?.total} / {parc?.planting?.plant_recus} </td>
                                  <td className="description align-middle white-space-nowrap text-center fw-bold text-700 py-2 pe-6">{parc?.taux_reussite} %</td>
                                  <td className="description align-middle white-space-nowrap text-center fw-bold text-700 py-2 pe-6"> 32 000</td>
                              </tr>
                              )}  
                          </tbody>
            </table>
