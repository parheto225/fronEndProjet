                                       ...
                                       <table className="table fs--1 mb-0">
                                         <thead>
                                           <tr>
                                             ...
                                             <th className="sort white-space-nowrap align-middle pe-3 ps-0 text-uppercase" scope="col" data-sort="subject" style={{"width":"10%", "min-width":"50px"}}>Date</th>
                                             <th className="sort align-middle pe-3 text-uppercase" scope="col" data-sort="sent" style={{"width":"15%", "min-width":"130px"}}>Plant vivant</th>
                                             <th className="sort align-middle text-start text-uppercase" scope="col" data-sort="date" style={{"min-width":"65px"}}>Plant mort</th>
                                             <th className="sort align-middle pe-0 text-uppercase" scope="col" style={{"width":"31%", "min-width":"100px"}}>Taux de mortalité</th>
                                             <th className="sort align-middle text-end text-uppercase" scope="col" data-sort="status" style={{"width":"15%", "min-width":"100px"}}>Action</th>
                                           </tr>
                                         </thead>
...
export default RemplacementActivity;