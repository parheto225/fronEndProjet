...
// import logoagm from '../assets/img/logo_akidompro.png'; logo_agromap1.png
import logoAkidom from '../assets/img/logo_akidompro.png';
import logoMondelez from '../assets/img/logo_mondelez.png';
          ...
          <div className="navbar-logo">
            ...
            <Link className="navbar-brand me-1 me-sm-3" to="/dash-coop/">
              <div className="d-flex align-items-center">
                <div className="d-flex align-items-center">
                  <img src={logoAkidom} alt="phoenix" style={{width: "230px", height: "200px", marginTop: "10px"}} />
                    {/* <img src={logoAkidom} alt="phoenix" style={{width: "230px", height: "200px"}} /> */}
                </div>
              </div>
            </Link>
          </div>
                 ...
                 {/*    <div className="mb-3 mx-3"><input className="form-control form-control-sm" id="statusUpdateInput" type="text" placeholder="Update your status" /></div> */}
                  ...
                  <div className="overflow-auto scrollbar" style={{"height": "10rem"}}>
                    <ul className="nav d-flex flex-column mb-2 pb-1">
                      <li className="nav-item"><a className="nav-link px-3" href="/list-projets/"> <span className="me-2 text-900" data-feather="user"></span><span>
                        {t("Mon Profile")}
                      </span></a></li>
